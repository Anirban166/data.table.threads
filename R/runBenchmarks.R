...
#' @examples
#' \dontrun{
#' # Running a set of benchmarks for a data.table with 10000000 rows and 10 columns, for thread counts going from 1 to the maximum number of available threads in the user's system:
